...
const Header = () => {
    return (
        <header className="flex items-center justify-center w-full fixed sm:sticky bottom-2 sm:top-4 z-10 sm:mb-5">
            <StyledContainer className="dark:bg-background/50">
                <motion.nav className="flex gap-3 sm:gap-8 items-center px-2 sm:px-10 py-2 sm:py-1 overflow-hidden"
                    initial="initial"
                    whileHover="hover"
                >
                    <motion.div
                    ...
                    />
                    <ul className="flex items-center gap-2 relative z-10 h-full">
                        {
                            navItems.map((item) => {
                                ...
                                return (
                                    <motion.li key={item.label} className="relative">
                                        ...
                                        >
                                            ...
                                            >
                                                <span className={`transition-colors duration-300 group-hover:${item.iconColor} dark:text-gray-200`}>
